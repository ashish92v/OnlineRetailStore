...
<script>
   	   ...
   	   $.ajax({
		    ...
		    success : function(result){
		    	...
		    	if(result!=null && result.length>0){
					...
					var  initialCode=  '<div id="basket" class="col-lg-9">'+
					'              <div class="box">'+
					'                <form method="get" >'+
					'                  <h1>Shopping cart</h1>'+
				...
				//	alert("json***********************"+obj);
					 for (i in obj.gadget) {
						 ...
						 image=obj.gadget[i].image;
				         gadgetId=obj.gadget[i].gadgetId;
				       	 product=obj.gadget[i].product;
				       	 price=obj.gadget[i].price;
				         productCount=obj.gadget[i].productCount;
				         userId=obj.gadget[i].userId;
  				         subTotal= parseFloat(subTotal)+ parseFloat(price);
				         productBody=productBody+  '<tr>'+
				'                          <td><a href="#"><img style="width:80px;" src="${pageContext.request.contextPath}/'+image+'" alt="White Blouse Armani"></a></td>'+
				'                          <td><a href="#">'+product+'</a></td>'+
				/* '                          <td>'+
				'                            <input id="productVal" type="number" value="'+productCount+'" class="form-control">'+
				'                          </td>'+
				 */'                          <td>$'+price+'</td>'+
				'                          <td>$0.00</td>'+
				'                          <td>$'+price+'</td>'+
				'                          <td><a href="deleteProduct?cartID='+gadgetId+'"><i class="fa fa-trash-o"></i></a></td>'+
				'                        </tr>';
					 }
					  
			//		 alert("test3");
					 totalAmount=parseFloat(10)+parseFloat(subTotal);
				//	 alert("test4"+totalAmount);
					 var  finalCode=initialCode+productBody+  '</tbody>'+
				'                      <tfoot>'+
				'                        <tr>'+
				...
				'                    <div class="right"><a href="checkout" class="btn btn-outline-secondary"><i class="fa fa-chevron-right"></i> Proceed to checkout</a></div>'+
	/* 			'                      <button class="btn btn-outline-secondary" onclick="updateCart(\''+gadgetId+'\',\''+productCount+'\')"><i class="fa fa-refresh"></i> Update cart</button>'+
	 ...
	 */			'                    </div>'+
				...
				'                </div>'+
				'                <p class="text-muted">Shipping and additional costs are exclusive of product price.</p>'+
				'                <div class="table-responsive">'+
				'                  <table class="table">'+
				'                    <tbody>'+
				'                      <tr>'+
				...
				'            </div>' ;
				  ...
				  document.getElementById("cartDemo").innerHTML = finalCode;
					
		    }else{
		    	
		    	var finalCode="<h3>Shopping Cart is empty</h3><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
		    	 document.getElementById("cartDemo").innerHTML = finalCode;
