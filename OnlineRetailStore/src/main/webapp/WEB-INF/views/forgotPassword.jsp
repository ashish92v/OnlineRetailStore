...
<section class="login_box_area section_gap">
	...
	<div id="message" style="color:red; text-align:center;"  class="col-lg-12"><h4>${msg}</h4></div>
						<h3><b>Password assistance</b></h3>
						<p>Enter the email address associated with your Phoenix account.</p>
						<form class="row login_form" action="forgotPasswordReq" method="GET" name="checklogin"  id="checklogin" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="username" name="username" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" id="forgotButton"  name="forgotButton" class="primary-btn" onclick="return checkLoginCredentials();">Continue</button>
							</div>
						</form>
					</div>
				</div>
